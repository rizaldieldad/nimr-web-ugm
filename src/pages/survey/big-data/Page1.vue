...
const GOOGLE_SCRIPT_URL = 'https://script.google.com/macros/s/AKfycbxXzSY3Cl6ZpiIQLbbkIVMiFkbPQKCMgtHBPOvnC-ZiGnfyMPa8ZPV39Rrf-4HP6eXi/exec'
...
const isFinishDisabled = computed(() => {
    ...
    surveyState.answers.bigData.q4 === null ||
    surveyState.answers.bigData.q5 === null ||
    surveyState.answers.bigData.q6 === null
})
    ...
    <div class="max-w-4xl mx-auto p-4 md:p-8 space-y-6">
        ...
        <div class="flex justify-end">
            <button @click="handleFinish" :disabled="isFinishDisabled" :class="[
                'px-8 py-3 font-bold rounded-full transition-all transform shadow-lg cursor-pointer',
                isFinishDisabled
