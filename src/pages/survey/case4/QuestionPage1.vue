...
// Initialize case4 page1 answers if not exists
...
const isNextDisabled = computed(() => {
    return surveyState.answers.case4.q1 === null ||
           surveyState.answers.case4.q2 === null
})
</script>
...
<template>
    <div class="max-w-4xl mx-auto flex flex-col justify-center min-h-screen p-4 md:p-8 space-y-6">
      ...
      <div class="flex justify-end gap-6">
        <!-- Back Button -->
       <BackButton back-route="/survey/case4"/>

        <!-- Next Button -->
        <NextButton :disabled="isNextDisabled" class="justify-end" next-route="/survey/case4/question-2"/>
      </div>
    </div>
</template>
