...
// Initialize case6 page1 answers if not exists
...
const isNextDisabled = computed(() => {
    return surveyState.answers.case6.q1 === null ||
           surveyState.answers.case6.q2 === null
})
</script>
    ...
    <div class="max-w-4xl mx-auto flex flex-col justify-center min-h-screen p-4 md:p-8 space-y-6">
      ...
      <div class="flex justify-end gap-6">
       ...
       <BackButton back-route="/survey/case6"/>
        ...
        <!-- Next Button -->
        <NextButton :disabled="isNextDisabled" class="justify-end" next-route="/survey/case6/question-2"/>
      </div>
    </div>
</template>
